...
Before accepting findings and drafting the formal report, read the [evidence contract and report template](../references/report-template.md). Load the [findings schema](../references/findings-schema.md) only for requested rendered report files.
...
7. Apply the evidence gate, classification rules, and ranking in the report reference. Return up to 12 substantive findings, including zero when none qualify. Do not hold a PR responsible for unrelated architecture.
